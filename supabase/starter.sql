...
values
  (1, 'Godsbanen', 'Skovgaardsgade 3', '8000', 'Aarhus C', 'https://godsbanen.dk/'),
  (2, 'Dokk1', 'Hack Kampmanns Plads 2', '8000', 'Aarhus C', 'https://dokk1.dk/'),
  (3, 'Institut for X', 'Skovgaardsgade 3F', '8000', 'Aarhus C', 'https://institutforx.dk/'),
  (4, 'Folkestedet', 'Carl Blochs Gade 28', '8000', 'Aarhus C', 'https://aarhus.dk/folkestedet/om-folkestedet'),
  (5, 'Lynfabrikken', 'Vestergade 49B', '8000', 'Aarhus C', null),
  (6, 'Aarhus Ø', 'Bernhardt Jensens Boulevard 175', '8000', 'Aarhus C', null),
  (7, 'Åboulevarden', 'Åboulevarden 55', '8000', 'Aarhus C', null)
...
alter table public.events
  add constraint "events_venueId_fkey"
...
alter table public.registrations add column if not exists "eventId" bigint;
...
alter table public.registrations alter column "eventId" set not null;
alter table public.registrations drop constraint if exists "registrations_eventId_fkey";
